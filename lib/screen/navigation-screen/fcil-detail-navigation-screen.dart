...
// class FcDetailNavigationScreen extends StatefulWidget {
//   const FcDetailNavigationScreen({Key? key}) : super(key: key);

//   @override
//   State<FcDetailNavigationScreen> createState() => _FcDetailNavigationScreen();
// }

// class _FcDetailNavigationScreen extends State<FcDetailNavigationScreen> {
//   int gottenStars = 4;
//   int selectedIndex = -1;
//   @override
//   Widget build(BuildContext context) {
//     return BlocBuilder<AppCubits, CubitStates>(builder: ((context, state) {
//       DetailFcState detail = state as DetailFcState;
//       return Scaffold(
//         body: Container(
